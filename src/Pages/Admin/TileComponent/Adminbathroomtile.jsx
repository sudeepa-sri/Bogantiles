...
const AdminBathroomTile = () => {
  ...
  useEffect(() => {
    const fetchTiles = async () => {
      try {
        const response = await axios.get('https://bogantilesbackend.onrender.com/api/tiles/category/bathroom');
  ...
  <input
    ...
    onChange={(e) => {
      ...
      if (/[^a-zA-Z ]/g.test(value)) {
        return;  // Prevent setting value if it contains non-alphabetic characters
      }
...
export default AdminBathroomTile;
