...
import '../Kitchentiles/Kitchentiles.css'; // Using the same CSS file for both Kitchen and Outdoor tiles

function Outdoortiles() {
  ...
  useEffect(() => {
    const fetchTiles = async () => {
      try {
        const response = await axios.get('https://bogantilesbackend.onrender.com/api/tiles/category/outdoor'); // Changed endpoint for outdoor category
  ...
  const handleViewDetails = (tileId) => {
    navigate(`/outdoor/${tileId}`); // Navigate to the outdoor details page
  };
