...
import './Kitchentiles.css'; // ✅ Using your separate CSS

function Kitchentiles() {
  ...
  const handleViewDetails = (tileId) => {
    navigate(`/kitchen/${tileId}`);
  };

  return (
    <div className="user-container"> {/* Wrapping the entire component with a class "user-container" */}
